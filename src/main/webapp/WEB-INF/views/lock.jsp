                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4"> 
                                    ...
                                    <div class="text-center mt-2">
                                        <h5 class="text-primary">잠금화면</h5>
                                        <p class="text-muted">비밀번호를 입력하여 잠금을 해제하세요.</p>
                                    </div>
                                        <form action="/home">
                                            ...
                                            <div class="mt-3 text-end">
                                                <button class="btn btn-primary w-sm waves-effect waves-light" type="submit">해제</button>
                                            </div>
                
    
                                            <div class="mt-4 text-center">
                                                <p class="mb-0">본인이 아닌가요? <a href="/login" class="fw-medium text-primary"> 로그인 </a></p>
                                            </div>
                                        </form>
                                    </div>
