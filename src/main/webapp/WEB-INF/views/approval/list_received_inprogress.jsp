...
<head>
<meta charset="UTF-8">
<title>List Received In Progress</title>
</head>
<body>
<div>
                    ...
                    <table class="table table-hover align-middle mb-0 text-center">
                        ...
                        <tbody>
                            ...
                            <c:if test="${empty docs}">
                                <tr>
                                    <td colspan="5" class="text-muted">진행 중인 결재 문서가 없습니다.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
