                    ...
                    <table class="table table-hover align-middle mb-0 text-center">
                        ...
                        <tbody>
                            ...
                            <c:if test="${empty docs}">
                                <tr>
                                    <td colspan="4" class="text-center text-muted">진행 중인 문서가 없습니다.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
